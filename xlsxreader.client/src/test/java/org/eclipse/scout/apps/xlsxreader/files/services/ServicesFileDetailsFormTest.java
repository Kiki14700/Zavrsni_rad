...
public class ServicesFileDetailsFormTest {
	@BeanMock
	private IServicesFileDetailsService m_mockSvc;
	// TODO [Kristian Knezevic] add test cases

	@Before
	public void setup() {
		ServicesFileDetailsFormData answer = new ServicesFileDetailsFormData();
