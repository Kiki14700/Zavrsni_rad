...
public class ImportStockDataDetailsFormTest {
	@BeanMock
	private IImportStockDataDetailsService m_mockSvc;
	// TODO [Kristian Knezevic] add test cases

	@Before
	public void setup() {
		ImportStockDataDetailsFormData answer = new ImportStockDataDetailsFormData();
