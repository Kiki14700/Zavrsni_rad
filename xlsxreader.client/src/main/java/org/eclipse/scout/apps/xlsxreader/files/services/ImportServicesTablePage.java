...
import org.eclipse.scout.apps.xlsxreader.files.prices.IImportPricesService;
import org.eclipse.scout.apps.xlsxreader.files.services.ImportServicesTablePage.Table;
...
@Data(ImportServicesTablePageData.class)
public class ImportServicesTablePage extends AbstractPageWithTable<Table> {
	@Override
	...
	protected Class<? extends ISearchForm> getConfiguredSearchForm() {
		return ServicesFilesSearchForm.class;
	}

	@Override
	protected void execLoadData(SearchFilter filter) {
		importPageData(BEANS.get(IImportServicesService.class)
				.getImportServicesTableData((ServicesFilesSearchFormData) filter.getFormData()));
	}

	@Override
	protected String getConfiguredTitle() {
		// TODO [Kristian Knezevic] verify translation
		return TEXTS.get("ImportServicesTablePage.ImportServices");
	}
	...
	public class Table extends AbstractTable {
		...
		protected void execRowAction(ITableRow row) {
			...
			ServicesFileDetailsForm form = new ServicesFileDetailsForm();
			if (importType == 1L) {
		...
		@Order(1000)
		public class ImportServicesMenu extends AbstractMenu {
			@Override
			protected String getConfiguredText() {
				return TEXTS.get("ImportServicesTablePage.Table.ImportServices");
			}
			...
			protected void execAction() {
				...
				ImportServicesForm form = new ImportServicesForm();
				form.startNew();
				form.waitFor();
				if (form.isFormStored()) {
					reloadPage();
		...
		public class DownloadMenu extends AbstractXLSXReaderDownloadMenu {
			...
			protected void execAction() {
				...
				byte[] file = BEANS.get(IImportServicesService.class).getFileContent(fileId);
		...
		@Order(3000)
		public class TemplatesMenu extends AbstractMenu {
			@Override
			protected String getConfiguredText() {
		...
		public class DeleteMenu extends AbstractDeleteMenu {
			...
			protected void execAction() {
				...
				BEANS.get(IImportServicesService.class).deleteFile(fileID);
				reloadPage();
			}
		}
		...
		public class IDColumn extends AbstractIntegerColumn {
			...
			protected String getConfiguredHeaderText() {
				return TEXTS.get("ImportServicesTablePage.Table.ID");
			}
		...
		public class NameColumn extends AbstractStringColumn {
			@Override
			protected String getConfiguredHeaderText() {
				return TEXTS.get("ImportServicesTablePage.Table.Name");
			}
		...
		public class ImportTypeColumn extends AbstractSmartColumn<Long> {
			@Override
			protected String getConfiguredHeaderText() {
				return TEXTS.get("ImportServicesTablePage.Table.ImportType");
			}
		...
		public class DateColumn extends AbstractDateColumn {
			@Override
			protected String getConfiguredHeaderText() {
				return TEXTS.get("ImportServicesTablePage.Table.Date");
			}
		...
		public class NumberOfItemsColumn extends AbstractStringColumn {
			@Override
			protected String getConfiguredHeaderText() {
				return TEXTS.get("ImportServicesTablePage.Table.NumberOfItems");
			}
		...
		public class CompanyColumn extends AbstractSmartColumn<Long> {
			@Override
			protected String getConfiguredHeaderText() {
				return TEXTS.get("ImportServicesTablePage.Table.Company");
			}
