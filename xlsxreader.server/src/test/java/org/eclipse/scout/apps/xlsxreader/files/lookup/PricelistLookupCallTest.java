...
public class PricelistLookupCallTest {
	// TODO [Kristian Knezevic] add test cases

	protected PricelistLookupCall createLookupCall() {
		return new PricelistLookupCall();
	}

	@Test
	public void testGetDataByAll() {
		PricelistLookupCall call = createLookupCall();
